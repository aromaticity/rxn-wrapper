...
var RXNWrapper = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        tree = (_a.sent()).payload.sequences[0].tree;
                        orderedTreeNodes = postOrderTreeTraversal(tree);
                        keysToKeep = ['id', 'smiles', 'actions', 'children'];
                        flattenedActions = [];
                        for (node in orderedTreeNodes) {
                            if (!keysToKeep.includes(node))
                                delete orderedTreeNodes[node];
                            if (orderedTreeNodes[node] !== undefined)
                                flattenedActions = flattenedActions.concat(orderedTreeNodes[node].actions);
                        }
    ...
    RXNWrapper.prototype.getSynthesisActionsWithSpectrometerPdf = function (synthesisId) {
        return __awaiter(this, void 0, void 0, function () {
            var result, _a, tree, orderedTreeNodes, flattenedActions, node, i;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        result = [];
                        return [4 /*yield*/, this.getSynthesisPlan(synthesisId)];
                    case 1:
                        _a = _b.sent(), tree = _a.tree, orderedTreeNodes = _a.orderedTreeNodes, flattenedActions = _a.flattenedActions;
                        for (node in orderedTreeNodes) {
                            for (i = 0; i <= orderedTreeNodes[node]['actions'].length; i++) {
    ...
    RXNWrapper.prototype.getSynthesisAnalysisReportPdf = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    RXNWrapper.prototype.startSynthesis = function (synthesisId) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
function postOrderTreeTraversal(tree) {
    var result = [];
    if ('children' in tree) {
